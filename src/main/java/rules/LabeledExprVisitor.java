...
public interface LabeledExprVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitPrintString(LabeledExprParser.PrintStringContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAssignString(LabeledExprParser.AssignStringContext ctx);
	/**
	 ...
	 * labeled alternative in {@link LabeledExprParser#block}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMultiple_logic_block(LabeledExprParser.Multiple_logic_blockContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitSingle_logic_block(LabeledExprParser.Single_logic_blockContext ctx);
	/**
